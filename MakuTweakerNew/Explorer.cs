...
public partial class Explorer : Page, IComponentConnector
{
	...
	private void LoadLang(string lang)
	{
		...
		lab.Text = dictionary["main"]["label"];
		e1.Header = dictionary["main"]["e1"];
		e2.Header = dictionary["main"]["e2"];
		e3.Header = dictionary["main"]["e3"];
		e4.Header = dictionary["main"]["e4"];
		e5.Header = dictionary["main"]["e5"];
		e6.Header = dictionary["main"]["e6"];
		e7.Header = dictionary["main"]["e7"];
		e8.Text = dictionary["main"]["e8"];
		fix.Content = dictionary["main"]["e8b"];
		e9.Text = dictionary["main"]["e9"];
		hide.Content = dictionary["main"]["choose"];
		showall.Content = dictionary["main"]["showall"];
		e1.OnContent = dictionary2["def"]["on"];
		e2.OnContent = dictionary2["def"]["on"];
		e3.OnContent = dictionary2["def"]["on"];
		e4.OnContent = dictionary2["def"]["on"];
		e5.OnContent = dictionary2["def"]["on"];
		e6.OnContent = dictionary2["def"]["on"];
		e7.OnContent = dictionary2["def"]["on"];
		e1.OffContent = dictionary2["def"]["off"];
		e2.OffContent = dictionary2["def"]["off"];
		e3.OffContent = dictionary2["def"]["off"];
		e4.OffContent = dictionary2["def"]["off"];
		e5.OffContent = dictionary2["def"]["off"];
		e6.OffContent = dictionary2["def"]["off"];
		e7.OffContent = dictionary2["def"]["off"];
	}
	...
	private async void hide_Click(object sender, RoutedEventArgs e)
	{
		...
		decimal num = await dialog.TaskCompletionSource.Task;
		if (num != -1m)
		{
			Registry.CurrentUser.CreateSubKey("Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer").SetValue("NoDrives", num, RegistryValueKind.DWord);
			mw.RebootNotify(2);
		}
